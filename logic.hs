...
data Formula = 
    ...
    | Not Formula                             -- jedyny unarny spójnik
...
freeInFormula var (Not phi) = freeInFormula var phi 
...
substInFormula (Not phi) var term = Just Not <*> substInFormula phi var term
...
eqMap (Not phi) (Not psi) m = eqMap phi psi m 
eqMap (Not _) _ _ = False 
